...
const Test1 = () => {
  ...
  const questions = [
    {
      question: "Как вы скажете 'Привет!' на английском языке?",
      options: ["Goodbye!", "Hello!", "Thank you!"],
      correct: 1
    },
    {
      question: "Как спросить, откуда человек, на английском языке?",
      options: ["What is your name?", "How are you?", "Where are you from?"],
      correct: 2
    },
    {
      question: "Как вы ответите на вопрос 'How are you?' если у вас все хорошо?",
      options: ["I'm fine, thank you.", "My name is John.", "Goodbye!"],
      correct: 0
    }
  ];
          ...
          <div>
            ...
            <div className="flex flex-col justify-center items-center  md:flex-row">
              {questions[currentQuestion].options.map((option, index) => (
                <button
                  key={index}
                  className="my-2 mx-2 py-2 px-4 bg-[#9D76F3] font-nunito font-bold text-xl rounded-lg text-white hover:scale-110 transition-all ease-linear"
            ...
            {isTestPassed ? (
              <div>
                ...
                <button
                  ...
                  onClick={() => navigate('/English/lesson4')}
                >
                  Далее
                </button>
              </div>
