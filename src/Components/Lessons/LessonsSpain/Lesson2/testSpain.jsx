...
const TestSpain = () => {
  ...
  const questions = [
    {
      question: "Какое произношение у буквы A в испанском слове 'casa'?",
      options: ["[a]", "[e]", "[æ]"],
      correct: 0
    },
    {
      question: "Какое произношение у буквы E в испанском слове 'escuela'?",
      options: ["[e]", "[i]", "[ɛ]"],
      correct: 2
    },
    {
      question: "Какое произношение у буквы O в испанском слове 'oso'?",
      options: ["[o]", "[ɒ]", "[oʊ]"],
      correct: 0
    }
  ];
            ...
            {isTestPassed ? (
              <div>
                ...
                <button
                  ...
                  onClick={() => navigate('/Spain/lesson3/Spain3')}
                >
                  Далее
                </button>
              </div>
