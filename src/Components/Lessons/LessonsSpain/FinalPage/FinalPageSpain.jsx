  ...
  return (
    <div className='bg-white '>
        <div className="container h-screen mx-auto flex flex-col justify-center items-center">
            <h1 className='font-bold font-nunito text-5xl text-center leading-relaxed'><span className='text-[#D2FF1F]'>Поздавляем</span>, вы прошли курс по испанскому языку!</h1>
