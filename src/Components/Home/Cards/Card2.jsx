...
import backgroundImage from '../../../img/greenflower.svg'; 
...
const Card2 = () => {
  ...
  return (
    <div className='relative rounded-[30px] my-10 bg-[#D2FF1F] p-5'>
      <div className='relative z-10 p-5'>
        <h1 className='font-bold font-nunito text-3xl lg:text-6xl text-black text-center lg:text-left'>Испанский язык</h1>
