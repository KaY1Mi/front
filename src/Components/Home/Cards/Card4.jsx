...
import backgroundImage from '../../../img/blueflower.svg'; 
...
const Card4 = () => {
  ...
  return (
    <div className='relative rounded-[30px] my-10 bg-[#0077B6] p-5'>
      <div className='relative z-10 p-5'>
        <h1 className='font-bold font-nunito text-3xl lg:text-6xl text-black text-center lg:text-left'>Французский язык</h1>
      ...
      <div className="flex flex-col lg:flex-row items-center pt-3 lg:pt-[180px] pb-2 justify-center lg:justify-between relative z-10">
        <div className="flex flex-col lg:flex-row items-center space-y-2 lg:space-y-0 lg:space-x-4">
          ...
          <div className="flex items-center justify-center lg:justify-start">
            ...
            <p className='px-2 lg:px-5 font-nunito font-bold text-lg lg:text-3xl'>10 000 ₽</p>
          </div>
        </div>
      ...
      <div className='hidden xl:block'>
        <img 
          src={backgroundImage} 
          alt="background" 
          className='absolute right-0 bottom-0 w-[45.5%]' 
          style={{ zIndex: 0 }}
        />
      </div>
    </div>
