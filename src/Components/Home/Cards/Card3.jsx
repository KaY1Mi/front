...
import backgroundImage from '../../../img/redflower.svg'; 
...
const Card3 = () => {
  ...
  return (
    <div className='relative rounded-[30px] my-10 bg-[#EC704B] p-5'>
      <div className='relative z-10 p-5'>
        <h1 className='font-bold font-nunito text-3xl lg:text-6xl text-black text-center lg:text-left'>Итальянский язык </h1>
      ...
      <div className='hidden xl:block'>
        <img 
          src={backgroundImage} 
          alt="background" 
          className='absolute right-0 bottom-0 w-[42.3%]' 
          style={{ zIndex: 0 }}
        />
      </div>
    </div>
