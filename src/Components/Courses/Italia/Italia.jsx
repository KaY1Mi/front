...
import BigFlower from '../../../img/Italia/Bigflower.svg'
import Btn from '../../../img/btn.svg'
import one from '../../../img/Italia/one.svg'
import two from '../../../img/Italia/two.svg'
import three from '../../../img/Italia/three.svg'
import four from '../../../img/Italia/four.svg'
import Slider from './Slider'
import FooterItalia from './FooterItalia'
...
const Modal = ({ show, onClose }) => {
  ...
  return (
    <div className="bg-[#EC704B] min-h-screen">
        <div className="container mx-auto pt-5">
            <Header />
            <div className="pt-10 lg:pt-20 xl:pt-32">
                <h1 className='font-nunito font-bold text-4xl lg:text-5xl xl:text-8xl text-[#FF4710] text-center lg:text-left'>
                    ИТАЛЬЯНСКИЙ
                </h1>
                <h1 
                className='font-nunito font-bold text-4xl lg:text-5xl xl:text-8xl text-[#FF4710] text-center lg:text-right'>
                    ЯЗЫК
                </h1>
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center text-center mt-10 lg:mt-20">
                <div className="mb-8 lg:mb-0 lg:mr-16">
                    <div className="font-nunito font-bold text-5xl lg:text-8xl text-[#FF4710] ">5</div>
                ...
                <div className="mb-8 lg:mb-0 lg:mx-16">
                    <div className="font-nunito font-bold text-5xl lg:text-8xl text-[#FF4710] ">8.5</div>
                    <div className="font-nunito font-bold text-3xl lg:text-6xl text-white pt-3 lg:pt-5">Рейтинг курса</div>
                </div>
                <div>
                    <div className="font-nunito font-bold text-5xl lg:text-8xl text-[#FF4710] ">3</div>
            ...
            <button 
                type="button" 
                className='flex justify-between items-center p-5 my-10 rounded-[20px] w-full bg-[#FF4710] py-8 transform shadow-lg transition duration-300 animate-pulse hover:scale-105'
                onClick={handlePay}
                >
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
                <div className="rounded-[40px] bg-white lg:col-span-2">
                    <div className="h-full flex flex-col lg:flex-row justify-between items-center">
                        <div className="p-4">
                            <h1 className='text-[#FF4710]  font-nunito font-bold text-3xl lg:text-5xl'>
                            ВЫДАЧА МАТЕРИАЛОВ
                            </h1>
