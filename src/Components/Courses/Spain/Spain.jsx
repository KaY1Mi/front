...
import BigFlower from '../../../img/Spain/Bigflower.svg'
import Btn from '../../../img/btn.svg'
import one from '../../../img/Spain/one.svg'
import two from '../../../img/Spain/two.svg'
import three from '../../../img/Spain/three.svg'
import four from '../../../img/Spain/four.svg'
import Slider from './Slider'
import FooterSpain from './FooterSpain'
...
const Modal = ({ show, onClose }) => {
  ...
  return (
    <div className="bg-[#D2FF1F] min-h-screen">
        <div className="container mx-auto pt-5">
            <Header />
            <div className="pt-10 lg:pt-20 xl:pt-32">
                <h1 className='font-nunito font-bold text-4xl lg:text-5xl xl:text-8xl text-[#84A501] text-center lg:text-left'>
                    ИСПАНСКИЙ
                </h1>
                <h1 
                className='font-nunito font-bold text-4xl lg:text-5xl xl:text-8xl text-[#84A501] text-center lg:text-right'>
                    ЯЗЫК
                </h1>
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center text-center mt-10 lg:mt-20">
                <div className="mb-8 lg:mb-0 lg:mr-16">
                    <div className="font-nunito font-bold text-5xl lg:text-8xl text-[#84A501] ">5</div>
                    <div className="font-nunito font-bold text-3xl lg:text-6xl text-black pt-3 lg:pt-5">Уроков</div>
                </div>
                <div className="mb-8 lg:mb-0 lg:mx-16">
                    <div className="font-nunito font-bold text-5xl lg:text-8xl text-[#84A501] ">7.3</div>
                    <div className="font-nunito font-bold text-3xl lg:text-6xl text-black pt-3 lg:pt-5">Рейтинг курса</div>
                </div>
                <div>
                    <div className="font-nunito font-bold text-5xl lg:text-8xl text-[#84A501] ">4</div>
                    <div className="font-nunito font-bold text-3xl lg:text-6xl text-black pt-3 lg:pt-5">Место</div>
                </div>
            </div>

            <button 
                type="button" 
                className='flex justify-between items-center p-5 my-10 rounded-[20px] w-full bg-[#84A501] py-8 transform shadow-lg transition duration-300 animate-pulse hover:scale-105'
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
                <div className="rounded-[40px] bg-white lg:col-span-2">
                    <div className="h-full flex flex-col lg:flex-row justify-between items-center">
                        <div className="p-4">
                            <h1 className='text-[#84A501]  font-nunito font-bold text-3xl lg:text-5xl'>
                            ВЫДАЧА МАТЕРИАЛОВ
                            </h1>
